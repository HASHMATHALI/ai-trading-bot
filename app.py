...
# Local imports (Updated for flat GitHub structure)
from data_pipeline import fetch_live_data, engineer_features
from risk_management import evaluate_risk, calculate_position_size
...
@st.cache_resource
def load_model():
    # Updated to look for the model in the exact same folder
    model_path = Path("trading_model.pkl")
    try:
